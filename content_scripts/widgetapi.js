(function () {
    console.log("widgetapi top func called");
    if (window.ugytwidgetapiHasRun) {
        return;
    }
    window.ugytwidgetapiHasRun = true;

    'use strict'; var n, ca = typeof Object.create == "function" ? Object.create : function (a) {
        function b() { }
    ...
    function la(a) {
        this.next = function (b) { z(a.g); a.g.h ? b = D(a, a.g.h.next, b, a.g.o) : (a.g.o(b), b = E(a)); return b };
    ...
    function ma(a) {
        ...
        return new Promise(function (d, k) {
            function g(f) { f.done ? d(f.value) : Promise.resolve(f.value).then(b, c).then(g, k) }
            g(a.next())
        })
    }
    function F(a) { return ma(new la(new ja(a))) }
    r("Symbol", function (a) {
        function b(g) { if (this instanceof b) throw new TypeError("Symbol is not a constructor"); return new c(d + (g || "") + "_" + k++, g) }
    ...
    r("Symbol.iterator", function (a) {
        if (a) return a; a = Symbol("Symbol.iterator"); p(Array.prototype, a, { configurable: !0, writable: !0, value: function () { return na(ia(this)) } });
        return a
    });
    function na(a) {
    ...
    r("Promise", function (a) {
        function b(f) { this.h = 0; this.i = void 0; this.g = []; this.o = !1; var e = this.j(); try { f(e.resolve, e.reject) } catch (h) { e.reject(h) } }
        ...
        b.prototype.j = function () {
            function f(l) { return function (m) { h || (h = !0, l.call(e, m)) } }
        ...
        b.prototype.then = function (f, e) {
            function h(w, A) { return typeof w == "function" ? function (aa) { try { l(w(aa)) } catch (ba) { m(ba) } } : A }
        ...
        b.prototype.B = function (f, e) {
            function h() { switch (l.h) { case 1: f(l.i); break; case 2: e(l.i); break; default: throw Error("Unexpected state: " + l.h); } }
        ...
        b.all = function (f) {
            var e = x(f), h = e.next(); return h.done ? d([]) : new b(function (l, m) {
                function u(aa) { return function (ba) { w[aa] = ba; A--; A == 0 && l(w) } }
    ...
    r("WeakMap", function (a) {
        function b(h) { this.g = (e += Math.random() + 1).toString(); if (h) { h = x(h); for (var l; !(l = h.next()).done;)l = l.value, this.set(l[0], l[1]) } }
        function c() { }
    ...
    r("Array.from", function (a) {
        return a ? a : function (b, c, d) {
            c = c != null ? c : function (e) { return e };
...
*/
    ...
    }, ua = Array.prototype.forEach ? function (a, b, c) { Array.prototype.forEach.call(a, b, c) } : function (a, b, c) { for (var d = a.length, k = typeof a === "string" ? a.split("") : a, g = 0; g < d; g++)g in k && b.call(c, k[g], g, a) };
...
*/
    ...
    function fb() {
        if (cb()) {
            var a = T.brands.find(function (b) { return b.brand === "Chromium" });
            if (!a || !a.version) return NaN; a = a.version.split(".")
        } else { a = eb(); if (a === "") return NaN; a = a.split(".") } return a.length === 0 ? NaN : Number(a[0])
    }
    ...
    function pb() {
        var a = new nb, b = ["https://www.youtube.com"]; b = b === void 0 ? mb : b; F(function (c) {
            switch (c.g) {
                case 1: return C(c, ob(), 2); case 2: if (!c.m) { c.g = 3; break } return C(c, Promise.all(b.map(function (d) { var k; return F(function (g) { if (g.g == 1) return g.l = 2, C(g, navigator.permissions.query({ name: "top-level-storage-access", requestedOrigin: d }), 4); g.g != 2 ? (k = g.m, k.state === "prompt" && a.g.push(d), g.g = 0, g.l = 0) : (g.l = 0, g.i = null, g.g = 0) }) })), 4);
    ...
    ; var xb = window;
    function X(a, b) {
        this.v = {}; this.playerInfo = {}; this.videoTitle = ""; this.j = this.g = null; this.h = 0; this.m = !1; this.l = []; this.i = null; this.C = {}; this.options = null; this.A = this.T.bind(this); if (!a) throw Error("YouTube player element ID required."); this.id = pa(this); b = Object.assign({ title: "video player", videoId: "", width: 640, height: 360 }, b || {}); var c = document; if (a = typeof a === "string" ? c.getElementById(a) : a) {
            xb.yt_embedsEnableRsaforFromIframeApi && pb(); c = a.tagName.toLowerCase() === "iframe"; b.host || (b.host = c ? jb(a.src) :
                "https://www.youtube.com"); this.options = b || {}; b = [this.options, window.YTConfig || {}]; for (var d = 0; d < b.length; d++)b[d].host && (b[d].host = b[d].host.toString().replace("http://", "https://")); if (!c) {
                    b = document.createElement("iframe"); c = a.attributes; d = 0; for (var k = c.length; d < k; d++) { var g = c[d].value; g != null && g !== "" && g !== "null" && b.setAttribute(c[d].name, g) } b.setAttribute("frameBorder", "0"); b.setAttribute("allowfullscreen", ""); b.setAttribute("allow", "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share");
                    b.setAttribute("referrerPolicy", "strict-origin-when-cross-origin"); b.setAttribute("title", "YouTube " + Y(this, "title")); (c = Y(this, "width")) && b.setAttribute("width", c.toString()); (c = Y(this, "height")) && b.setAttribute("height", c.toString()); this.j = a; (c = a.parentNode) && c.replaceChild(b, a); a = yb(this, b); c = "" + Y(this, "host") + zb(this) + "?"; d = []; for (var f in a) kb(f, a[f], d); f = c + d.join("&"); if (xb.yt_embedsEnableIframeSrcWithIntent) {
                        var e = e === void 0 ? Ta : e; a: if (e = e === void 0 ? Ta : e, f instanceof L) e = f; else {
                            for (a = 0; a < e.length; ++a)if (c =
                                e[a], c instanceof Sa && c.S(f)) { e = new L(f); break a } e = void 0
                        } e = e || Ra; b.removeAttribute("srcdoc"); f = "allow-same-origin allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-storage-access-by-user-activation".split(" "); b.setAttribute("sandbox", ""); for (a = 0; a < f.length; a++)b.sandbox.supports && !b.sandbox.supports(f[a]) || b.sandbox.add(f[a]); if (e instanceof L) if (e instanceof L) e = e.g; else throw Error(""); else e = Ua.test(e) ? e : void 0; e !== void 0 && (b.src = e); b.sandbox.add("allow-presentation",
                            "allow-top-navigation")
                    } else b.src = f; a = b
                } this.g = a; this.g.id || (this.g.id = "widget" + pa(this.g)); W[this.g.id] = this; if (window.postMessage) { this.i = new U; Ab(this); b = Y(this, "events"); for (var h in b) b.hasOwnProperty(h) && this.addEventListener(h, b[h]); for (var l in rb) rb.hasOwnProperty(l) && Bb(this, l) }
        }
    }
    ...
    function yb(a, b) {
        var c = Y(a, "playerVars"); c ? c = Ja(c) : c = {}; window !== window.top && document.referrer && (c.widget_referrer = document.referrer.substring(0, 256)); var d = Y(a, "embedConfig"); if (d) { if (I(d)) try { d = JSON.stringify(d) } catch (k) { console.error("Invalid embed config JSON", k) } c.embed_config = d } c.enablejsapi = window.postMessage ? 1 : 0; window.location.host && (c.origin = window.location.protocol + "//" + window.location.host); c.widgetid = a.id; window.location.href && ua(["debugjs", "debugcss"], function (k) {
    ...
    function Ib(a, b) {
        b = x(b); for (var c = b.next(), d = {}; !c.done; d = { u: void 0 }, c = b.next())d.u = c.value, a[d.u] || (d.u === "getCurrentTime" ? a[d.u] = function () { var k = this.playerInfo.currentTime; if (this.playerInfo.playerState === 1) { var g = (Date.now() / 1E3 - this.playerInfo.currentTimeLastUpdated_) * this.playerInfo.playbackRate; g > 0 && (k += Math.min(g, 1)) } return k } : vb(d.u) ? a[d.u] = function (k) {
            return function () {
                this.playerInfo = {};
                this.v = {}; Db(this, k.u, arguments); return this
            }
        }(d) : wb(d.u) ? a[d.u] = function (k) {
            return function () {
                var g = k.u, f = 0;
                g.search("get") === 0 ? f = 3 : g.search("is") === 0 && (f = 2); return this.playerInfo[g.charAt(f).toLowerCase() + g.substring(f + 1)]
            }
        }(d) : a[d.u] = function (k) {
            return function () {
    ...
    function Fb(a, b, c) {
        Z || (Z = {}, Jb = new Set, Lb.addEventListener("message", function (d) {
            a: if (Jb.has(d.origin)) {
                try { var k = JSON.parse(d.data) } catch (e) { break a } var g = Z[k.id]; if (g && d.origin === g.O) switch (d = g.U, d.m = !0, d.m && (ua(d.l, d.sendMessage, d), d.l.length = 0), g = k.event, k = k.info, g) {
                    case "apiInfoDelivery": if (I(k)) for (var f in k) k.hasOwnProperty(f) && (d.v[f] = k[f]); break; case "infoDelivery": Hb(d, k); break; case "initialDelivery": I(k) && (clearInterval(d.h), d.playerInfo = {}, d.v = {}, Ib(d, k.apiInterface), Hb(d, k)); break; case "alreadyInitialized": clearInterval(d.h);
    ...
    typeof YTConfig !== "undefined" && YTConfig.parsetags && YTConfig.parsetags !== "onload" || sb(); var Mb = H.onYTReady; Mb && Mb(); var Nb = H.onYouTubeIframeAPIReady; Nb && Nb(); var Ob = H.onYouTubePlayerAPIReady; Ob && Ob();
}).call(this);
